...
The following types satisfy this interface:
	...
	github.com/lxdcc/gophercloud/openstack/identity/v2/tokens.CreateResult
	github.com/lxdcc/gophercloud/openstack/identity/v3/tokens.CreateResult

Usage example:

	import (
		"github.com/lxdcc/gophercloud"
		tokens2 "github.com/lxdcc/gophercloud/openstack/identity/v2/tokens"
		tokens3 "github.com/lxdcc/gophercloud/openstack/identity/v3/tokens"
	)
