...
import (
	...
	baremetalHTTPBasic "github.com/lxdcc/gophercloud/openstack/baremetal/httpbasic"
	baremetalNoAuth "github.com/lxdcc/gophercloud/openstack/baremetal/noauth"
	blockstorageNoAuth "github.com/lxdcc/gophercloud/openstack/blockstorage/noauth"
)
...
func AcceptanceTestChoicesFromEnv() (*AcceptanceTestChoices, error) {
	...
	/* // Temporarily disabled, see https://github.com/lxdcc/gophercloud/issues/1345
	if networkID == "" {
