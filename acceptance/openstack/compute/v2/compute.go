...
import (
	...
	"github.com/lxdcc/gophercloud/openstack/blockstorage/v2/volumes"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/aggregates"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/attachinterfaces"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/bootfromvolume"
	dsr "github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/defsecrules"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/floatingips"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/keypairs"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/networks"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/quotasets"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/remoteconsoles"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/rescueunrescue"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/schedulerhints"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/secgroups"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/servergroups"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/tenantnetworks"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/extensions/volumeattach"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/flavors"
	"github.com/lxdcc/gophercloud/openstack/compute/v2/servers"
	neutron "github.com/lxdcc/gophercloud/openstack/networking/v2/networks"
